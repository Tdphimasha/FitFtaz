...
class OutputAnalyzer {
    private final HeartRateActivity activity;
    ...
    // Method to detect a valley in the signal
    private boolean detectValley() {
        ...
        if (subList.size() < valleyDetectionWindowSize) {
            ...
            // Check if all measurements in the sublist are lower than the reference value
    ...
    void measurePulse(TextureView textureView, CameraService cameraService) {
        ...
        timer = new CountDownTimer(measurementLength, measurementInterval) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                Thread thread = new Thread(() -> {
                    ...
                    if (detectValley()) {
                        ...
                        // Calculate the current heart rate value
            ...
            public void onFinish() {
                ...
                // Calculate the heart rate and measurement duration
                String currentValue = String.format(
                        Locale.getDefault(),
                ...
                // Add the raw measurement values to the output
        ...
        // Update the view state and start the measurement timer
        activity.setViewState(HeartRateActivity.VIEW_STATE.MEASUREMENT);
        timer.start();
    }
    ...
    // Method to send a message to the main thread
